		...
		<div class="container-fluid" style="padding-right: 0px !important;padding-left: 0px !important; padding-top: 80px !important;"> 
			...
			<div id="myCarousel" style="padding-right: 0px !important;padding-left: 0px !important;" class="carousel slide carousel-fade col-md-12" data-ride="carousel" data-interval="5000">
	...
	<!-- Main -->
		<div id="main">
			<div id="content" class="container-fluid pull-center" style="padding-left: 0px; padding-right: 0px;">
				<div class="">
							...
							<figure class="effect-zoe">
								<a href="<?php echo $idioma; ?>-<?php echo $lnkMenuAneis; ?>">
									...
									<figcaption>
										...
										<!-- <p class="description">Anel em ouro amarelo com diamantes, citrino e ametista.</p> -->
									</figcaption>	
								</a>		
							</figure>
						</div>
							...
							<figure class="effect-zoe pull-center">
								<a href="<?php echo $idioma; ?>-<?php echo $lnkMenuBrincos; ?>">
									...
									<figcaption>
										...
										<!-- <p class="icon-links">
											<a href="#" title="<?php echo $subMenuBrincos; ?>"><span></span></a>
										</p> -->								
							...
							<figure class="effect-zoe pull-right">
								<a href="<?php echo $idioma; ?>-<?php echo $lnkMenuPingentes; ?>">
									...
									<figcaption>
										...
										<!-- <p class="icon-links">
											<a href="#" title="<?php echo $subMenuPingentes; ?>"><span></span></a>
										</p> -->								
										<!-- <p class="description">Anel em ouro amarelo com diamantes, citrino e ametista.</p> -->
									</figcaption>
								</a>
							...
							<figure class="effect-zoe">
								<a href="<?php echo $idioma; ?>-<?php echo $lnkMenuConjuntos; ?>">
									...
									<figcaption>
										...
										<!-- <p class="icon-links">
											<a href="#" title="<?php echo $subMenuConjuntos; ?>"><span></span></a>
										</p> -->								
									</figcaption>	
								</a>		
							</figure>
							...
							<figure class="effect-zoe pull-center">
								<a href="<?php echo $idioma; ?>-<?php echo $lnkMenuPulseiras; ?>">
									...
									<figcaption>
										...
										<!-- <p class="icon-links">
											<a href="#" title="<?php echo $subMenuPulseiras; ?>"><span></span></a>
										</p> -->								
										<!-- <p class="description">Anel em ouro amarelo.</p> -->
									</figcaption>
								</a>
							...
							<figure class="effect-zoe pull-right">
								<a href="<?php echo $idioma; ?>-<?php echo $lnkLancamento; ?>">
									...
									<figcaption>
										...
										<!-- <p class="icon-links">
											<a href="#" title="<?php echo $menuLancamento; ?>"><span></span></a>
										</p> -->								
									</figcaption>
								</a>
							</figure>
